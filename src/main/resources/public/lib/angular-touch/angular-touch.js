...
//		var MOVE_BUFFER_RADIUS = 10;
	...
	function makeSwipeDirective(directiveName, direction, eventName) {
		ngTouch.directive(directiveName, ['$parse', '$swipe', function($parse, $swipe) {
			// The maximum vertical delta for a swipe should be less than 75px. <- nope.
			var MAX_VERTICAL_DISTANCE = 250;
			// Vertical distance should not be more than a fraction of the horizontal distance (0.3). <- wrong.
			var MAX_VERTICAL_RATIO = 2;
